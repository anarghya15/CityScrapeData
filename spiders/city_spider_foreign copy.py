...
class CityParagraphsSpider(scrapy.Spider):
  ...
  start_urls = ["https://en.wikipedia.org/wiki/Salzburg", 
  ...
  "https://en.wikipedia.org/wiki/Tarn%C3%B3w", 
  ...
  "https://en.wikipedia.org/wiki/Seraing",
  "https://en.wikipedia.org/wiki/Rovigo",
  "https://en.wikipedia.org/wiki/Valence,_Dr%C3%B4me",
